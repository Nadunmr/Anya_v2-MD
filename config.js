...
module.exports = {
     ...
     */
    ownername: process.env.OWNER_NUMBER || process.env.Owner_Name || "NADU_MD",
    ownernumber: process.env.Owner_Number || "94742290168",
    ...
    sessionId: process.env.SESSION_ID || "i54PF0LVDo6G6_A_N_Y_A_V_2_aIttp6F",
